...
class TechOverlayControl {
  ...
  onClearClicked(event) {
    ...
    //   },
    // };
    const requestType = "BroadcastCustomEvent";
    const data = {
      eventData: { testKey: "testValue", testKey2: "another" },
    };
