...
obs.on("CustomEvent", (eventData) => {
  if (eventData.AGEOVERLAYPUSH) {
    document.dispatchEvent(new Event("obs-websocket-overlay-push-event"), eventData);
  }
